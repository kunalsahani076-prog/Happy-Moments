...
import decoIndiaImage1 from './assets/Deco India 2023/WhatsApp Image 2026-09-22 at 11.30.07 AM.jpeg'
import decoIndiaImage2 from './assets/Deco India 2023/0e14d607-d573-4893-a126-f8d00d2ba2d8.jpg'
...
const decoIndiaImages = [decoIndiaImage1, decoIndiaImage2]
...
export default function DecoIndiaPage() {
  return (
    <div className="gallery-page">
      ...
      <main className="gallery-detail">
        ...
        <h1>Deco India <em>2023</em></h1>
        <p className="gallery-intro">A collection of moments and experiences from Deco India 2023.</p>
        <section className="gallery-detail-grid" aria-label="Deco India 2023 photos">
          {decoIndiaImages.map((image, index) => <article className="gallery-detail-card" key={image}><img src={image} alt={`Deco India 2023 event photo ${index + 1}`} /></article>)}
        </section>
      </main>
