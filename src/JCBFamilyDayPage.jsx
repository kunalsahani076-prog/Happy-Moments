...
const jcbFamilyDayImages = Object.entries(import.meta.glob('./assets/Gallery-page/JCB Family Day 2024/*', { eager: true, query: '?url', import: 'default' }))
...
export default function JCBFamilyDayPage() {
  return (
    <div className="gallery-page">
      ...
      <main className="gallery-detail">
        ...
        <h1>JCB Family Day <em>2024</em></h1>
        <p className="gallery-intro">A collection of moments and experiences from JCB Family Day 2024.</p>
        <section className="gallery-detail-grid" aria-label="JCB Family Day 2024 photos">
          {jcbFamilyDayImages.map((image, index) => <article className="gallery-detail-card" key={image}><img src={image} alt={`JCB Family Day 2024 event photo ${index + 1}`} /></article>)}
        </section>
      </main>
