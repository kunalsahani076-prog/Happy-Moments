...
const hdfcTownHallImages = Object.entries(import.meta.glob('./assets/Gallery-page/HDFC Town Hall/*', { eager: true, query: '?url', import: 'default' }))
...
export default function HDFCTownHallPage() {
  return (
    <div className="gallery-page">
      ...
      <main className="gallery-detail">
        ...
        <h1>HDFC Town <em>Hall</em></h1>
        <p className="gallery-intro">A collection of moments and experiences from HDFC Town Hall.</p>
        <section className="gallery-detail-grid" aria-label="HDFC Town Hall photos">
          {hdfcTownHallImages.map((image, index) => <article className="gallery-detail-card" key={image}><img src={image} alt={`HDFC Town Hall event photo ${index + 1}`} /></article>)}
        </section>
      </main>
