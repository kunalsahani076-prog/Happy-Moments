...
import autoExpoImage1 from './assets/Gallery-page/AutoExpo 2023/WhatsApp Image 2026-09-22 at 10.55.00 AM.jpeg'
import autoExpoImage2 from './assets/Gallery-page/AutoExpo 2023/WhatsApp Image 2026-09-22 at 10.54.53 AM.jpeg'
import autoExpoImage3 from './assets/Gallery-page/AutoExpo 2023/WhatsApp Image 2026-09-22 at 10.54.52 AM.jpeg'
import autoExpoImage4 from './assets/Gallery-page/AutoExpo 2023/WhatsApp Image 2026-09-22 at 10.54.52 AM (1).jpeg'
import autoExpoImage5 from './assets/Gallery-page/AutoExpo 2023/WhatsApp Image 2026-09-22 at 10.53.01 AM.jpeg'
...
const autoExpoImages = [autoExpoImage1, autoExpoImage2, autoExpoImage3, autoExpoImage4, autoExpoImage5]
...
export default function AutoExpoPage() {
  return (
    <div className="gallery-page">
      ...
      <main className="gallery-detail">
        ...
        <h1>AutoExpo <em>2023</em></h1>
        <p className="gallery-intro">A look back at the energy, experiences, and moments from AutoExpo 2023.</p>
        <section className="gallery-detail-grid" aria-label="AutoExpo 2023 photos">
          {autoExpoImages.map((image, index) => <article className="gallery-detail-card" key={image}><img src={image} alt={`AutoExpo 2023 event photo ${index + 1}`} /></article>)}
        </section>
      </main>
