...
const indiaStonemartImages = Object.entries(import.meta.glob('./assets/Gallery-page/India Stonemart 2024/*', { eager: true, query: '?url', import: 'default' }))
...
export default function IndiaStonemartPage() {
  return (
    <div className="gallery-page">
      ...
      <main className="gallery-detail">
        ...
        <h1>India Stonemart <em>2024</em></h1>
        <p className="gallery-intro">A collection of moments and experiences from India Stonemart 2024.</p>
        <section className="gallery-detail-grid" aria-label="India Stonemart 2024 photos">
          {indiaStonemartImages.map((image, index) => <article className="gallery-detail-card" key={image}><img src={image} alt={`India Stonemart 2024 event photo ${index + 1}`} /></article>)}
        </section>
      </main>
