...
const v1SirsaCupImages = Object.entries(import.meta.glob('./assets/Gallery-page/V1 Sirsa Cup/*', { eager: true, query: '?url', import: 'default' }))
...
export default function V1SirsaCupPage() {
  return (
    <div className="gallery-page">
      ...
      <main className="gallery-detail">
        ...
        <h1>V1 Sirsa <em>Cup</em></h1>
        <p className="gallery-intro">A collection of moments and experiences from V1 Sirsa Cup.</p>
        <section className="gallery-detail-grid" aria-label="V1 Sirsa Cup photos">
          {v1SirsaCupImages.map((image, index) => <article className="gallery-detail-card" key={image}><img src={image} alt={`V1 Sirsa Cup event photo ${index + 1}`} /></article>)}
        </section>
      </main>
