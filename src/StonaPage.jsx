...
const stonaImages = Object.entries(import.meta.glob('./assets/Gallery-page/Stona 2025 Bangalore/*', { eager: true, query: '?url', import: 'default' }))
...
export default function StonaPage() {
  return (
    <div className="gallery-page">
      ...
      <main className="gallery-detail">
        ...
        <h1>Stona <em>2025 Bangalore</em></h1>
        <p className="gallery-intro">A collection of moments and experiences from Stona 2025 Bangalore.</p>
        <section className="gallery-detail-grid" aria-label="Stona 2025 Bangalore photos">
          {stonaImages.map((image, index) => <article className="gallery-detail-card" key={image}><img src={image} alt={`Stona 2025 Bangalore event photo ${index + 1}`} /></article>)}
        </section>
      </main>
